...
Author= Milaim Kas
Theory and equations: Sasis Chuchurca and Milaim Kas
...
- for ground state case: L1-ECW-CCS or L1-ECW-CCSD where L1 stands for L1 regularized.
...
- Vexp^{nm} potentials contain one-emectron transition properties related to the n->m transition
